...
const RequestFixSavingsCard = ({ setShowModal }) => {
  const requestFixedSavingsHandler = () => {
    setShowModal(false);
  };
  ...
  return (
    <>
      ...
      >
        ...
        <Button
          onClick={requestFixedSavingsHandler}
          background="#15A7BF"
          fontSize={"11.7px"}
          btnText={"Request Saving"}
          size="large"
        />
        <Spacer />
      </DefaultCardstyle>
...
export default RequestFixSavingsCard;
